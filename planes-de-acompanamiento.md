...
{% columns %}
{% column %}
<figure><img src=".gitbook/assets/nosProtegue.png" alt=""><figcaption></figcaption></figure>
{% endcolumn %}
...
{% column %}
<figure><img src=".gitbook/assets/nosCuida.png" alt=""><figcaption></figcaption></figure>
{% endcolumn %}
{% endcolumns %}

{% columns %}
{% column %}
<figure><img src=".gitbook/assets/nosImpulsa.png" alt=""><figcaption></figcaption></figure>
{% endcolumn %}
...
{% column %}
<figure><img src=".gitbook/assets/nosAcompaña.png" alt=""><figcaption></figcaption></figure>
{% endcolumn %}
{% endcolumns %}

{% columns %}
{% column %}
<figure><img src=".gitbook/assets/nosIntegramos.png" alt=""><figcaption></figcaption></figure>
{% endcolumn %}
